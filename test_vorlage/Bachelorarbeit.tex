...
\newcommand{\titel}{Titel der Diplomarbeit}
\newcommand{\untertitel}{längerer Untertitel mit genauerer Tehemenbezeichnung}
\newcommand{\arbeit}{Bachelorarbeit}
\newcommand{\studiengang}{Bowling}
\newcommand{\autor}{Walter Sobchak}
\newcommand{\matrikelnr}{123 456}
\newcommand{\kurs}{TIT07B1}
\newcommand{\firma}{THE DUDE AG, Nürnberg}
\newcommand{\abgabe}{\today}
\newcommand{\betreuerdhbw}{Prof. Jesus Quintana}
\newcommand{\betreuerfirma}{Dipl.-Inf. Karl Hungus}

\newcommand{\jahr}{2009}			% für Angabe im Copyright-Vermerk der Titelseite
...
\bibitem[FoBa03]{foobar2003} Dominik Feininger, Foo, John; Bar, Belinda:
\emph{Titel :
Untertitel},\\ Verlagsort: Verlag, Jahr der Auflage. S. 10-20 \bibitem[Le01]{levy2001} Autor Name: \emph{Titel des Buches}, New York: Penguin Books, 2001
